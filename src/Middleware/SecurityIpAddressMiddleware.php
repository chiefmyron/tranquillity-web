...
// Copied from Rob Allen's akrabat/ip-address-middleware
// @see https://github.com/akrabat/ip-address-middleware 
class SecurityIpAddressMiddleware implements MiddlewareInterface {
    /**
     ...
     */
    public function __construct($checkProxyHeaders = false, array $trustedProxies = null, $attributeName = null, array $headersToInspect = []) {
